...
!define COMMENTS "NsisMultiUser UMUI Full Demo, based on the Ultra Modern and ModernUIEx User Interfaces, using the standard MUI dialogs"
!define URL_INFO_ABOUT "https://github.com/Drizin/NsisMultiUser/tree/master/Demos/UMUI_Ex_Full"
