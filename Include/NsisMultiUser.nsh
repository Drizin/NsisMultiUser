...
!macro MULTIUSER_UNINIT_VARS
	...
	!else ifdef MULTIUSER_INSTALLMODE_CHANGE_MODE_FUNCTION 	
		!define MULTIUSER_INSTALLMODE_CHANGE_MODE_FUNCTION ${MULTIUSER_INSTALLMODE_CHANGE_MODE_FUNCTION} ; old code - changed function name
