...
!ifdef LANG_JAPANESE
	...
	LangString MULTIUSER_INSTALL_PAGE_SUBTITLE ${LANG_JAPANESE} "どのユーザーのために $(^NameDA) をインストールするかの選択。"
	LangString MULTIUSER_UNINSTALL_PAGE_SUBTITLE ${LANG_JAPANESE} "どのユーザーのために $(^NameDA) をアンインストールするかの選択。"
	...
	LangString MULTIUSER_NEW_INSTALLATION_ALL_USERS ${LANG_JAPANESE} "全ユーザーに対する新規インストール。"
	LangString MULTIUSER_NEW_INSTALLATION_CURRENT_USER ${LANG_JAPANESE} "現在のユーザに対する新規インストール。"
	LangString MULTIUSER_INSTALLED_ALL_USERS ${LANG_JAPANESE} "バージョン {VERSION} が $\"{FOLDER}$\" に全ユーザーにインストールされています。"
	LangString MULTIUSER_INSTALLED_CURRENT_USER ${LANG_JAPANESE} "バージョン {VERSION} が $\"{FOLDER}$\" に現在のユーザーにインストールされています。"
	LangString MULTIUSER_REINSTALL_SAME_VERSION_ALL_USERS ${LANG_JAPANESE} "{VERSION} を全員に対して再インストール。"
	LangString MULTIUSER_REINSTALL_SAME_VERSION_CURRENT_USER ${LANG_JAPANESE} "{VERSION} を現在のユーザーに対して再インストール。"
